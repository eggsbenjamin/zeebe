...
public class DeploymentsState {
  ...
  private final ZbLong deploymentKey;
  private final ColumnFamily<ZbLong, PendingDeploymentDistribution> pendingDeploymentColumnFamily;

  public DeploymentsState(ZeebeDb<ZbColumnFamilies> zeebeDb) {

    deploymentKey = new ZbLong();
