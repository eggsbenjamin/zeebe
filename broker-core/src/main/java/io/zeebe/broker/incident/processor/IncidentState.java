...
public class IncidentState {
  ...
  private final ZbLong incidentKey;

  private final UnpackedObjectValue incident;
  private final ColumnFamily<ZbLong, UnpackedObjectValue> incidentColumnFamily;

  /** element instance key -> incident key */
  private final ZbLong elementInstanceKey;

  private final ColumnFamily<ZbLong, ZbLong> workflowInstanceIncidentColumnFamily;

  /** job key -> incident key */
  private final ZbLong jobKey;

  private final ColumnFamily<ZbLong, ZbLong> jobIncidentColumnFamily;

  public IncidentState(ZeebeDb<ZbColumnFamilies> zeebeDb) {
    this.zeebeDb = zeebeDb;

    incidentKey = new ZbLong();
  ...
  public long getWorkflowInstanceIncidentKey(long instanceKey) {
    ...
    final ZbLong incidentKey = workflowInstanceIncidentColumnFamily.get(elementInstanceKey);
  ...
  public long getJobIncidentKey(long jobKey) {
    ...
    final ZbLong incidentKey = jobIncidentColumnFamily.get(this.jobKey);
